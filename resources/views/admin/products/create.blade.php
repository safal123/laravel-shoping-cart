  ...
  <div class="card">
    ...
    <form id="productForm" enctype="multipart/form-data" method="post" role="form">
      ...
      <div class="card-footer">
        <button type="submit" class="border-success p-2 d-flex product-create btn btn-sm btn-success">
          <div id="btn-spinner" class="d-none mr-2 spinner-border text-light" style="width: 1.2rem; height: 1.2rem;" role="status">
