    ...
    <div class="row">
                    ...
                    <form action="{{ route('payment') }}" method="POST" id="payment-form">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="first_name" class="form-control" id="firstName" value="{{ auth()->user()->name }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="billing_email" value={{ auth()->user()->email }} class="form-control" id="email" placeholder="you@example.com">
                            <!-- <div class="invalid-feedback">
        ...
        <div class="col-md-4">
            <h4 class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span class="badge badge-secondary badge-pill text-sm p-2">{{ Cart::content()->count() }} items.</span>
            </h4>
